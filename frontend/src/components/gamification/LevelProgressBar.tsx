...
export function LevelProgressBar({ level, currentXP, xpForNext, progressPercentage }: LevelProgressBarProps) {
    return (
        <GlassCard className="p-6 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 border-indigo-500/30">
            <div className="flex justify-between items-end mb-2">
                ...
                <div className="text-right">
                    <span className="text-xs text-slate-400">{currentXP} / {xpForNext} XP</span>
                </div>
            </div>
